      ...
      <section className="py-20 px-6 bg-[var(--vintage-dark)] text-[var(--vintage-cream)]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#catalogo"
              className="px-8 py-4 bg-[var(--vintage-gold)] text-[var(--vintage-dark)] rounded hover:bg-[var(--vintage-bronze)] transition-colors cursor-pointer inline-block"
            >
              Ver Catálogo
            </a>
            <a
      ...
      <footer className="py-12 px-6 bg-[var(--vintage-dark)] border-t border-[var(--vintage-bronze)]/30">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              <h3 className="text-[var(--vintage-gold)] mb-4">
                Taller Artesanal
              </h3>
            ...
            <div>
              <h4 className="text-[var(--vintage-cream)] mb-4">Especialidades</h4>
            ...
            <div>
              <h4 className="text-[var(--vintage-cream)] mb-4">Ubicación y Contacto</h4>
